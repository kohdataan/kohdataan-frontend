...
const GroupsContainer = (props) => {
  ...
  const updateTownSquareOpen = () => {
    ...
    const startTime1 = dayjs('15 04 2022, 00:00:00', format2)
    const endTime1 = dayjs('19 04 2022, 00:00:00', format2)
    const startTime2 = dayjs('26 05 2022, 00:00:00', format2)
    const endTime2 = dayjs('27 05 2022, 00:00:00', format2)
